...
const About = () => {
  ...
  const translations = {
    en: {
      ...
      description: 'Try dishes that will open up new tastes for you and delight your eyes with their appearance. Here you will find a cozy atmosphere, excellent service and attention to each guest. Book a table now and enjoy a unique experience of taste discovery!'
    },
    ru: {
      aboutUs: 'О нас',
      journeyText: 'Путешествие по вкусам Cafesio',
      description: 'Попробуйте блюда, которые откроют для вас новые вкусы и порадуют глаз своим видом. Здесь вы найдете уютную атмосферу, отличное обслуживание и внимание к каждому гостю. Забронируйте столик сейчас и наслаждайтесь уникальным опытом открытия вкусов!'
    }
  };
